...
def update_version(new_version=None):
    ...
    try:
        ...
        subprocess.run(['git', 'add', 'src/metaclass_registry/__init__.py', 'pyproject.toml'], check=True)
...
def main():
    parser = argparse.ArgumentParser(description='Update metaclass-registry version number')
